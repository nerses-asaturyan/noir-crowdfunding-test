...
import CrowdfundingContractArtifactJson from '../crowdfunding/target/crowdfunding_contract-Crowdfunding.json' assert { type: 'json' };
  ...
  public static get events(): {
    ...
    return {
      WithdrawalProcessed: {
        ...
        eventSelector: EventSelector.fromString('0x6f9303c1'),
